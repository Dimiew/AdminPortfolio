...
class educationController extends Controller
{
    ...
    {
        $data = [];
        return view('dashboard.education.create')->with('data', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('education.index')->with('success','Berhasil melakukan update Education');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('education.index')->with('','Berhasil melakukan delete data Education');
    } 
}
