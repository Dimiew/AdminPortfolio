...
class experienceController extends Controller
{
    ...
    {
        $data = [];
        return view('dashboard.experience.create')->with('data', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required' => 'Judul tulisan wajib diisi',
        ...
        return redirect()->route('experience.index')->with('success','Berhasil memasukkan data Experience');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate(
            ...
            [
                'judul.required' => 'Posisi tulisan wajib diisi',
                'info1.required' => 'Nama Perusahaan wajib diisi',
                'tgl_mulai.required' => 'Tanggal Mulai wajib diisi',
                'isi.required' => 'isian tulisan wajib diisi',
            ]
        ...
        return redirect()->route('experience.index')->with('success','Berhasil melakukan update experience');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('experience.index')->with('','Berhasil melakukan delete data');
    } 
}
